...
prism_CAF_files="/storage/shared/barwu/10thTry/NDCAF/28m/*/FHC.290*.CAF.root"
...
def processFiles(f):
    ...
    #for f in f_list :
        ...
        output="/storage/shared/barwu/10thTry/combined1/28m/"+splitext(basename(f))[0]+"_Eff.root"
