...
void populate_histograms(char* eff,char* CAF,vector<TH1D*>hists1,vector<TH1D*>hists2,vector<TH1D*>hists3)
{
  ...
  cout<<"True visible energy; neutrino energy";
  ...
  for (int i=0;i<nentries2;i++) {
    ...
    double xz_mom_angle=XLepMom/ZLepMom;
    double yz_mom_angle=YLepMom/ZLepMom;
    if (abs(xz_mom_angle)<0.3&&abs(yz_mom_angle)<0.3) {continue;}
    cout<<endl<<i<<"; ";
